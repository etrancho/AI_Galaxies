...
file(INSTALL DESTINATION "/usr/lib/python2.7/dist-packages" TYPE SHARED_LIBRARY FILES "/home/nvidia/jetson-inference/build/aarch64/lib/python/2.7/jetson_utils_python.so")
  if(EXISTS "$ENV{DESTDIR}/usr/lib/python2.7/dist-packages/jetson_utils_python.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/lib/python2.7/dist-packages/jetson_utils_python.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/lib/python2.7/dist-packages/jetson_utils_python.so"
         OLD_RPATH "/usr/lib/aarch64-linux-gnu/tegra:/usr/lib/python2.7/dist-packages/numpy/core/include/../lib:/home/nvidia/jetson-inference/build/aarch64/lib:/usr/local/cuda/lib64:"
         NEW_RPATH "")
...
file(INSTALL DESTINATION "/usr/lib/python2.7/dist-packages" TYPE DIRECTORY FILES "/home/nvidia/jetson-inference/utils/python/bindings/../python/Jetson")
endif()
